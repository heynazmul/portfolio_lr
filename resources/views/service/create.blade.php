<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto p-8">
        <form method="POST" action="{{ route('service.store') }}" class="space-y-8 bg-white shadow-md rounded-lg p-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="url_title" id="url_title" value="{{ old('url_title') }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
