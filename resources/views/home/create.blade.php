        ...
        <form method="POST" action="{{ route('home.store') }}">
            ...
            <div class="space-y-8 bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" value="{{ old('title_1') }}" name="title_1" id="title_1" placeholder="Write your title" 
                        class="block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm
                        {{ $errors->has('title_1') ? '!border-red-500' : '' }}">
                        @error('title_1')
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" value="{{ old('title_2') }}" name="title_2" id="title_2" placeholder="Write your title" 
                        class="block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        @error('title_2')
                            <span class="text-sm text-red-500">{{ $message }}</span>
                        @enderror
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" value="{{ old('focus_title') }}" name="focus_title" id="focus_title" placeholder="Write your focus title" 
                        class="block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    @error('focus_title')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" id="description" rows="4" placeholder="Write a few sentences about yourself" 
                        class="block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
