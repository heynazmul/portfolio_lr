        ...
        <form method="POST" action="{{route('home.update', $home->id)}}">
            ...
            <div class="space-y-8 bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="focus_title" id="focus_title" value="{{ $home->focus_title }}" placeholder="Write your focus title" 
                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>

                <!-- home Field -->
                <div class="space-y-2">
                    <label for="home" class="block text-sm font-medium text-gray-700">home</label>
                    <textarea name="home"  id="home" rows="4" placeholder="Write a few sentences home yourself" 
                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description', $home->description) }}</textarea>
