            ...
            <div class="fixed inset-y-auto right-16 top-[25%]">
                <ul class="border border-white rounded-full p-5  space-y-5  text-white">
                    ...
                    <li>
                        <a href="#" class="">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                <path d="M3 22H21C21 17.5817 16.9706 14 12 14C7.02944 14 3 17.5817 3 22Z"
                        ...
                        <a href="#" class="">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path
                                    ...
                                    stroke="currentcolor" stroke-width="1.5" stroke-linejoin="round" />
                                <circle cx="17.5" cy="18" r="4" stroke="currentcolor" stroke-width="1.5"
                                    stroke-linejoin="round" />
                                <path d="M9.49994 14.5L2.5 21.5M2.50006 14.5L9.5 21.5" stroke="currentcolor"
                    ...
                    <li>
                        <a href="#" class="">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 3.5H22V20.5H2V3.5Z" stroke="currentcolor" stroke-width="1.5"
                                    stroke-linejoin="round" />
            ...
            <div class="col-span-full lg:col-span-3 px-5 ">
                <section class="relative">
                    <div class="lg:fixed w-full lg:w-[350px] mx-auto">
                        <div
                            class="border border-gray duration-300 hover:border-green rounded-3xl text-white text-center relative">
                            ...
                            <div class="p-5 space-y-6">
                                ...
                                <div class="px-5 space-y-4 lg:text-xl flex-col justify-center">
                                    ...
                                    <div>
                                        <ul class="flex justify-center items-center gap-5 ">
                                            <li class="group">
                                                <a href="#"
                                                    class="border-2 border-gray h-[50px] w-[50px]   group-hover:border-green rounded-full flex justify-center items-center duration-500">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                        viewBox="0 0 448 512" fill="currentcolor"
                                                        class="text-gray group-hover:text-green duration-500">
                                ...
                                <div class="flex justify-center font-semibold">
                                    <a href="#"
                                        class=" w-64 flex items-center h-10 rounded-full bg-green hover:bg-black-100 border-2 border-green text-center p-2 text-black  gap-2 py-5 px-5 hover:text-green duration-500 text-black-100 justify-center">
            ...
            <div class="col-span-full lg:col-span-8 px-20 relative">
                ...
                <section class="pb-14 px-10">
                    <div class="space-y-16">
                        ...
                        <div>
                            ...
                            <p class="text-6xl text-white leading-[80px] ">{{$data->title_1}} <span
                                    class="text-green">{{$data->focus_title}}</span> {{$data->title_2}}</p>
                            <p class="text-gray leading-10">{{$data->description}}</p>
                            @empty
                            <p class="text-6xl text-white leading-[80px] ">Hi From <span class="text-green">.....</span>
                                laravel Developer</p>
                        ...
                        <div class="flex justify-end">
                            <a href="#" class="relative  rounded-full inline-flex border  border-gray h-44 w-44 p-4">
                                <img h-full w-full class="h-full w-full animate-spin"
                                    src="{{asset('assets/round-text.png')}}" alt="round-text"
                                    style="animation-duration: 10s;">
                                <div class="absolute bottom-16 right-[72px] text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" class="w-8 h-10">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <section class="py-16 space-y-10 px-10">
                    ...
                    <div class="text-white space-y-5">
                        ...
                        <p class="text-5xl leading-[80px]">{{$about->title}} <span
                                class="text-green">{{$about->focus_title}}</span></p>

                        <p class="text-gray leading-8">{{$about->description}}</p>
                        @empty
                        <p class="text-5xl leading-[80px]">No About <span class="text-green">Data</span></p>
                        @endforelse
                    </div>
                </section>
                <!--RESUME-->
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <svg class="w-10 h-10" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <path d="M12 14L17.5 18.5M12 14L6.5 18.5M12 14V7" stroke="#28C949"
                                                    stroke-width="1.5" />
                                                <path
                                        ...
                                        <p class="group-hover:underline text-white">{{$data->url}}</p>
                                    </div>
                                </div>
                            </div>
                            @empty
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-between">
                                            <div class="space-y-3">
                                                ...
                                                <p class="text-gray">I created digital products with unique ideas use
                                                    Figma
                                                    & Framer</p>
                                            </div>
                                            <svg class="w-10 h-10" viewBox="0 0 24 24" fill="none"
                ...
                <section class="py-16">
                    <div class=" space-y-10">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 justify-center">
                            <div class="space-y-4 ">
                                <div href="#"
                                    class="border-[2px]  border-gray h-[231px] lg:w-[174.5px] md:w-full hover:border-green rounded-full flex flex-col justify-center items-center duration-500">
                ...
                <section>
                    <div class="wave-group relative">
                        <input required="" type="text"
                            class="input text-base px-1.5 py-4 block w-full border-b-2 border-gray-400 bg-transparent focus:outline-none">
                        <span
                            class="bar relative block w-full before:content-[''] before:absolute before:left-1/2 before:h-0.5 before:w-0 before:bottom-0 before:bg-green-700 before:duration-300 after:content-[''] after:absolute after:h-0.5 after:w-0 after:bottom-0 after:bg-green-700 after:duration-300 after:right-1/2 "></span>
